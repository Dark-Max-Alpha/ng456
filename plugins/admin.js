...
Aqua.addrex({pattern: 'ban ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.BAN_DESC, deleteCommand: false}, (async (message, match) => {
...
Aqua.addrex({pattern: 'add(?: |$)(.*)', fromMe: true, onlyGroup: false, desc: Lang.ADD_DESC, deleteCommand: false}, (async (message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Aqua.addrex({pattern: 'promote ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.PROMOTE_DESC}, (async (message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Aqua.addrex({pattern: 'demote ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.DEMOTE_DESC, deleteCommand: false }, (async (message, match) => {
    var im = await checkImAdmin(message);
...
Aqua.addrex({pattern: 'mute ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.MUTE_DESC , deleteCommand: false }, (async (message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Aqua.addrex({pattern: 'unmute ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.UNMUTE_DESC, deleteCommand: false}, (async (message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN,MessageType.text);
...
Aqua.addrex({pattern: 'invite ?(.*)', fromMe: true, onlyGroup: false, desc: Lang.INVITE_DESC, deleteCommand: false}, (async (message, match) => {
    var im = await checkImAdmin(message);
    if (!im) return await message.client.sendMessage(message.jid,Lang.IM_NOT_ADMIN, MessageType.text);
