...
Trex.addrex({pattern: 'play ?(.*)', fromMe: true, desc: Lang.PLAY_DESC}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'sokj ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
    ...
    Trex.addrex({pattern: 'sbvgzb ?(.*)', fromMe: true, desc: Lang.SONG_DESC}, (async (message, match) => { 
...
Trex.addrex({pattern: 'vszfbv ?(.*)', fromMe: true, desc: 'hu'}, (async (message, match) => { 
