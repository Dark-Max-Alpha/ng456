...
Aqua.addrex({ pattern: 'ig ?(.*)', fromMe: wk, desc:Lang.INSTA_DESC, deleteCommand: false }, async (message, match) => {
...
Aqua.addrex({ pattern: 'insta ?(.*)', fromMe: wk, desc:Lang.I_DESC, deleteCommand: false }, async (message, match) => {
  const iglink = match[1]
